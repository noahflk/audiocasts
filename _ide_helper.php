...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Utilities\Pathlib $instance */
                        return $instance->allDirectories($directory);
        }
                    /**
         * 
         ...
         * @static 
         */ 
        public static function files($directory, $includePath = true)
        {
                        /** @var \App\Utilities\Pathlib $instance */
                        return $instance->files($directory, $includePath);
        }
...
namespace  { 
            ...
            class Pathlib extends \App\Facades\Pathlib {}
